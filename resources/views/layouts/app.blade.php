...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        <header class="flex items-center justify-between px-8 py-4">
            <a href="#"><img width="50" height="50" src="{{ asset('img/logo.png') }}" alt="logo"></a>
            <div class="flex items-center">
                ...
                @endif
                <a href="#">
                    <img src="https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp" alt="" class="w-10 h-10 rounded-full">
                </a>
            </div>
        </header>
        ...
        <main class="container mx-auto max-w-custom flex">
            <div class="w-70 mr-5">
                Add idea form goes here. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Provident non iure, quibusdam harum quo accusantium. Amet, est? Fugiat facilis quisquam illo rerum modi, quia non optio, placeat ipsam sit corporis!
            </div>
            <div class="w-175">
