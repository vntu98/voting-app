        ...
        <div class="mt-8">
            @if ($hasVoted)
                <button
                    ...
                    class="w-20 bg-blue text-white border-blue hover:bg-blue-hover bg-gray-200 border border-gray-200 hover:border-gray-400 font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3"
                >
                    Voted
                </button>
            @else
        ...
        <div class="w-full flex flex-col justify-between mx-2">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                ...
                <div class="flex items-center md:hidden mt-4 md:mt-0">
                    ...
                    @if ($hasVoted)
                        <button
                            class="w-20 bg-blue text-white hover:bg-blue-hover bg-gray-200 border border-gray-200 font-bold text-xxs uppercase rounded-xl hover:border-gray-400 transition duration-150 ease-in px-4 py-3 -mx-5"
                        >
                            Vote
                        </button>
                    @else
